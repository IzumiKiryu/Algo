...
// L'entrée de la fonction, c'est ce qui correspond aux arguments, donc les valeurs que l'on donne à la fonction au moment de l'appel.
// La sortie de la fonction, c'est ce qui correspond au return. 

// Quand on voit ça comme une boîte noire, en étant à l'extérieur et en appuyant sur le bouton "Go", il y a (potentiellement) des valeurs (qu'on a données) qui rentrent dans la fonction, et il peut y avoir une valeur qui sort, le résultat.
